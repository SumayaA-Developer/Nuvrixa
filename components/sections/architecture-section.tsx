    ...
    <section id="architecture" className="py-20 sm:py-28">
      <Container>
        <SectionHeading
          ...
          title="A hub-and-spoke automation architecture for modern service businesses."
          description="Nuvrixa turns scattered inputs into a controlled operating layer where AI, people and tools each know what to do next."
          align="center"
        />
        <div className="mt-14">
          <ArchitectureMap />
